...
main:
    ...
    addiu $t0, $t0, 16           # Move $t0 to point to the last element of array1
    addiu $t1, $t1, 16           # Move $t1 to point to the last element of array2
    addiu $t3, $t3, 16           # Move $t3 to point to the last element of result
